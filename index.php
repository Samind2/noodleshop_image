...
<head>
    ...
    <title>CRUD Customer Information with Enlarge Image1111</title>
            ...
            <div class="col-md-12"> <br>
                ...
                <table id="customerTable" class="display table table-striped  table-hover table-responsive table-bordered ">
                    ...
                    <tbody>
                        ...
                        require 'connect.php';
                        $sql =
                            'SELECT * FROM foodmenu, foodtype WHERE foodmenu.FoodType_ID = foodtype.FoodType_ID';
